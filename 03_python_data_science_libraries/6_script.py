...
print(employees)
print(orders)
print(employees_orders)

# notes
    # an example of a one to many join
    # the merge method allows you to specify the columns to join on in both dataframes 
    # the left on parameter in the merge method is used to specify the column in the calling dataframe
    # the right on parameter in the merge method is used to specify the column in the other dataframe